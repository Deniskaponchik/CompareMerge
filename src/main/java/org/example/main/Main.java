...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        if(cmd.hasOption("d")) {
            ...
            System.out.println("Sort " + sortKind);
        } else {
        ...
        /*
        if(cmd.hasOption("i")) {
            String fileKind = cmd.getOptionValue("intFileOpt");
            System.out.println("File " + fileKind);
        } else {
            String fileKind = cmd.getOptionValue("strFileOpt");
            System.out.println("File " + fileKind);
        } */
        String inputFilePath = cmd.getOptions(fileTypeOptGroup());
        System.out.println("Input " + outputFilePath);
